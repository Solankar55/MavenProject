...
<div class="page-content">
		<div class="page-header">
			<center>
				<h1>DisApproved NSS Student List(Print Report)</h1>
			</center>
		</div>
		<form action="PrintDisApproveNSSStudent.html" method="get">
		<div class="row">
			<div class="col-xs-12">
				<!-- PAGE CONTENT BEGINS -->
				<div class="row">
					<div class="col-xs-12">
						<table id="simple-table" class="table  table-bordered table-hover">
							...
							<tbody>
							<% int i=0; %>
								<c:forEach var="G" items="${GetNSSStudentListDisApproved }">
						...
						<input type="hidden" id="CountDis" name="CheckCountDis">
						<button type="submit" class="btn btn-sm btn-success"
							name="PrintSubmitStudentNSSDis" id="SubmitCheck">
							Print 
