...
<script type="text/javascript">
	$(document).ready(function() 
	{
		...
		$("#StreamID").change(function(){
			...
			$.getJSON('GetBranchListJsonCultural.html',{id : id}).done(function(data) 
			...
			$.getJSON('GetStandardListJSONCultural.html',{branchid : branchid}).done(function(data) {
				//alert(data[0].branchId);
...
<div class="page-content">
		...
		<form action="InviteStudentCultural.html" method="post" class="form-horizontal">
		<div class="row">
			<div class="col-xs-12">
				<!-- PAGE CONTENT BEGINS -->
			...
			<div class="col-xs-12">
				...
				<div class="form-group ">
					...
					<div class="col-sm-3 control-label no-padding-right">
						<button type="submit" class="btn btn-sm btn-success" id="SubmitCheck" value="Send Link" name="SendCulturalMessage"
