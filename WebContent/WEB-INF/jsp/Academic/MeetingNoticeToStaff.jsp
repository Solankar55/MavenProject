...
<div class="page-content">
		<div class="page-header">
			<center>
				<h1><b>Meeting Notice For Staff</b></h1>
			</center>
		</div>
		<form action="sendMeetingNoticeToStaff.html"  method="post" id="" class="form-horizontal">
		<div class="row">
			<div class="col-xs-12">
				<!-- PAGE CONTENT BEGINS -->
				...
				<div class="form-group">
						...
						<label class="col-sm-3 control-label no-padding-right">
							Meeting Notice:<span style="color:red;">*</span></label>
						<div class="col-sm-6">
							<textarea class="form-control" id="" rows="10"
								placeholder="Notice To Student" name="MeetingNotice" required></textarea>
						</div>
					</div>
			</div>
		</div>
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<input type="hidden" id="Count" name="CheckCount">
							<button type="submit" class="btn btn-sm btn-success" name="SendNoticeToStaff"
								id="SubmitCheck">
								Send... <i
