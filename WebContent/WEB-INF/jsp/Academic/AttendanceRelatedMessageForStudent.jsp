...
<div class="page-content">
		<div class="page-header">
			<center>
				<h1><b>Attendance Related Message To Student</b></h1>
			</center>
		</div>
		<form action="SendAttendanceMessage.html"  method="post" id="" class="form-horizontal">
		<div class="row">
			<div class="col-xs-12">
				<!-- PAGE CONTENT BEGINS -->
				...
				<div class="form-group">
						...
						<label class="col-sm-3 control-label no-padding-right">
							Attendance Related Message:<span style="color:red;">*</span></label>
						<div class="col-sm-6">
							<textarea class="form-control" id="" rows="10"
								placeholder="Attendance Related Message To Student" name="AttendanceMessage" required></textarea>
						</div>
					</div>
			</div>
		</div>
				...
				<div class="row">
					<div class="col-xs-12">
						...
						<input type="hidden" id="Count" name="CheckCount">
							<button type="submit" class="btn btn-sm btn-success" name="AttendanceMessage"
								id="SubmitCheck">
								Send... <i
