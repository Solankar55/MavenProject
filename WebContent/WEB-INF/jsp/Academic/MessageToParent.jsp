...
<script type="text/javascript">
	$(document).ready(function() 
	{
		...
		$("#StreamID").change(function(){
			...
			$.getJSON('GetBranchListJsonStandardForYearParent.html',{id : id}).done(function(data) 
			...
			$.getJSON('GetStandardListJSONStandardForYearParent.html',{branchid : branchid}).done(function(data) {
				//alert(data[0].branchId);
			...
			$("#standardName").change(function(){
				...
				$("#StudentData").empty();
				$.getJSON('StudentAndParentRecord.html',{yearId:yearId,streamid:streamid,branchid : branchid,standardID:standardID}).done(function(data) {
...
<div class="page-content">
		...
		<form action="sendMessageToParent.html"  method="post" id="" class="form-horizontal">
		<div class="row">
			<div class="col-xs-12">
				<!-- PAGE CONTENT BEGINS -->
