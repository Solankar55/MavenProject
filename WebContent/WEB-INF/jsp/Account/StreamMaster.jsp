...
<title>Stream Master page</title>
<style type="text/css">
button {
	color: blue;
	width: 100px;
...
<body>
	<div class="page-content">
		<form action="SaveStream.html" method="post" id=""
			class="form-horizontal">

			<div class="page-header center">
				<h1><b>Stream Master Page</b></h1>
			</div>
			<div class="row">
				<div class="col-xs-12">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" name="streamName" class="col-xs-3" id=""
								placeholder="Stream Name" required pattern="[a-z A-Z]+"
								title="Please Enter Correct Stream Name" />
						</div>
					</div>
					<div class="form-group ">
					...
					<div class="row">
						<div class="col-xs-12">
							<table id="dynamic-table" class="table  table-bordered table-hover">
								...
								<tbody id="StreamOperation">
									<c:forEach var="StreamListV" items="${StreamList}">
										<tr
											onclick="document.getElementById('Oprations').style.display='block'">
											<td><c:out value="${StreamListV.streamId}"></c:out></td>
											<td><c:out value="${StreamListV.streamName}"></c:out></td>
										</tr>
									</c:forEach>
								</tbody>
							</table>
		...
		<script type="text/javascript">
			$("#StreamOperation tr").click(function() {
				//alert("HooBhoo");

				$("#StreamID").val($(this).find("td").eq(0).text());
		...
		<div id="Oprations" class="modal">
			<form class="modal-content animate" action="StreamOpration.html"
				method="post">
				...
				<div class="container">
					<table class="">
						<tr>
							...
							<td><input type="text" name="StreamID" id="StreamID"
								readonly="true"></td>
						
							<td><label><b>Stream Name :<span
										style="color: red;">*</span></b></label></td>
							<td><input type="text" name="StreamName" id="StreamName"
								required pattern="[a-z A-Z]+"
								title="Please Enter Correct Stream Name"></td>
						</tr>
					</table>
					<br>
					<center>
						<button type="submit" name="Update" value=""
							...
							class="btn btn-xs btn-success">Update Stream</button>
						
					<button type="submit" name="Delete" value=""
						onclick="document.getElementById('Oprations').style.display='none'"
						class="btn btn-xs btn-success">Delete Stream</button>
