...
<body>
	<div class="page-content">
		<div class="page-header center">
			<h1>Set Active Academic Year Master Page</h1>
			<br>
		</div>
		
		<form action="SaveActiveYear.html" class="form-horizontal" method="get">
		<div class="row">
			<div class="col-xs-12">
				<div class="form-group">
					<label class="col-sm-3 control-label no-padding-right">
						Activate Academic Year: </label>
						<div class="col-sm-9">
						<select class="col-xs-3" name="ActiveYearID"
								id="">
					...
					<button name="" id=""
							value="Active Year" class="btn btn-big btn-success">
							Active Year</button>
					</div>
					</div>
				</div>
