...
<title>Approve Student ID</title>
<style type="text/css">
...
<div class="page-content">
		<div class="page-header center">
			<h1><b>Approve Student ID</b></h1><br>
		</div>
<div class="row">
			<div class="col-xs-12">
				<!-- PAGE CONTENT BEGINS -->
						...
						<table id="dynamic-table" class="table  table-bordered table-hover">
							<thead>
							 ...
							 <tbody id="ledgerTable">
								 <c:forEach var="v" items="${StudIDRequestInfo}">
	 ...
	 <div id="id01" class="modal">
		...
		<s:form class="modal-content animate" action="TakeID.html"
	...
	<div id="id02" class="modal">
		...
		<s:form class="modal-content animate" action="IDCardCancel.html"
			method="post" commandName="">
			<div class="imgcontainer">
