...
$("#document").ready(function(){
	$("#StudentID").blur(function() {
		...
		$.getJSON('getstudentLCDetailsDuplicate.html',{registrationID : registrationID}).done(function(data) {
		//alert("In Data");
		 if(data.length==0)
		{
		alert("Student Not Recived His/Her Leaving Certificate Yet");
		}
	else
		{
...
<body>
	<div class="page-content">
		<div class="page-header center">
			<h1><b>Download Duplicate Student Leaving Certificate</b></h1>
		...
		<form action="DownloadLCACDuplicate.html" method="post" target="_blank">
			<div class="row">
				<div class="col-xs-12">
					<!-- PAGE CONTENT BEGINS -->
					<div class="row">
			...
			<hr>
			<div class="center">
				<button id="sendReq" name="DownloadDuplicateCertificate" type="submit"
