...
/*$("#branchName").change(function(){
	...
	alert(branch);
		...
		$('#checkDeclaration').click(function() {
	        ...
	        {
	            $('#TakeAddmission').show();
	           // document.getElementById('TakeAddmission').disabled = true;
	        } else {
	            $('#TakeAddmission').hide();
	        }
	    });
...
$(document).ready(function(){
 	...
 	$("#nameasper").blur(function(){
		...
		//alert(studNameScc);
	$.getJSON('spliteStudName.html',{studNameScc:studNameScc}).done(function(data){
 	...
 	$("#StudentUserName").blur(function(){
		...
		var StudEmail=$("#Email").val();
		var studContact=$("#ContactNumber").val();
		//alert(UserNameValue);
		$.getJSON('checkStudentUserNameJSON.html',{UserNameValue:UserNameValue,StudEmail:StudEmail,studContact:studContact}).done(function(data){
			...
			if(data.length!=0)
				...
				{
					 document.getElementById('TakeAddmission').disabled = false;
				}
		});
	});
 });
...
<body>
	<form action="TakeStudentAdmiossionByAccountant.html" method="post"
		enctype="multipart/form-data">
		<div class="page-content">
			<div class="page-header center">
				<h1><b>Accountant Student Admission Page</b></h1>
							...
							<div class="widget-main">
								...
								<div>
									<label for="form-field-select-1">Branch Name <span
										...
										<option id="dynamic" value="0">....Select Branch....</option>
								...
								<div>
									<label for="form-field-select-1">Standard <span
										...
										<option id="dynamicStd" value="0">....Select
											Standard....</option>
							...
							<div class="widget-main">
								...
								<div>
									<label for="form-field-8">Full Name (As Per the SSC
										...
										name="studentnamessc" placeholder="Surname Middlename Fathername"
								...
								<div>
									<input type="text" class="form-control" id="lastName"
										name="studentLastName" placeholder="Last Name" /> <br> <input
										type="text" class="form-control" id="firstName"
										name="studentFirstName" placeholder=" First Name"  /><br>
									<input type="text" class="form-control" id="middleName"
										name="studentMiddleName" placeholder=" Middle Name" /> <br>
								...
								<div>
									<label for="form-field-select-1">Gender <span
										style="color: red;">*</span></label> <select class="form-control"
										id="form-field-select-1" name="studentGender">
					...
					<div class="widget-box">
						...
						<div class="widget-body">
							<div class="widget-main">
								...
								<hr />
								<div>
									<label for="form-field-8">Student Email ID <span
							...
							<div class="widget-main">
								...
								<div>
									<label for="form-field-8">Eligibility Number</label> <input
										type="text" class="form-control" id="unino" name="uniidnumber"
					...
					<div class="widget-box">
						...
						<div class="widget-body">
							<div class="widget-main">
								...
								<hr />
								<div>
									<label for="form-field-8">Last Year scholarship Applied</label>
									<input type="text" class="form-control" id="lysa"
								...
								<div>
									<label for="form-field-8">Previous school Name /
										Address 
									</label> <input type="text" class="form-control" id="psna"
								...
								<br>
								<center>
									<button type="button" id="FPage" class="btn btn-sm btn-success">
										Previous <i
											class="ace-icon fa fa-arrow-left icon-on-left bigger-110"></i>
									</button>

									<button type="button" id="TPage" class="btn btn-sm btn-success">
										Next <i
											class="ace-icon fa fa-arrow-right icon-on-right bigger-110"></i>
									</button>
							...
							<div class="widget-main">
								...
								<div>
									<label for="form-field-8">MHT-CET <span
										...
										placeholder="PCM " /> <br> <input type="text"
										class="form-control" id="hscpcb" name="hscPCBMarks"
										placeholder=" PCB" /> <br> <input
								...
								<div>
									...
									<input type="text" class="form-control" id="hsctm"
										name="hscTotalMarks" placeholder="Total Marks" /> <br> <input
										type="text" class="form-control" id="hscoom"
										name="hscOutOfMarks" placeholder=" Out Of Marks" /> <br>
									<input type="text" class="form-control" id="hscper"
										name="hscpcbpcm" placeholder="  HSC Persentage"
										readonly="true" />
								</div>
								<hr />
								<script>
									...
									<input type="text" class="form-control" id="ssctm"
										name="sscTotalMarks" placeholder="Total Marks" /> <br> <input
										type="text" class="form-control" id="sscoom"
										name="sscOutOfMarks" placeholder=" Out Of Marks" /> <br>
						...
						<div class="widget-body">
							<div class="widget-main">
								...
								<div>
									...
									<%-- <label for="form-field-select-1"></label>Bank Name <select
								...
								<div>
									...
									<%-- <label for="form-field-select-1">Bank Branch</label> <select
								...
								<hr />
								<center>
									<button type="button" id="SPage" class="btn btn-sm btn-success">
										Previous <i
											class="ace-icon fa fa-arrow-left icon-on-left bigger-110"></i>
									</button>
							...
							<div class="widget-main">
								...
								<div style="display: none;">
									...
									<textarea class="form-control" id="FPermanentAddress"
										...
										placeholder="Father Permanent Address"></textarea>
								</div>
								<div>
								...
								<hr />
								<div>
									<label for="form-field-8">Occupation</label> <input type="text"
										class="form-control" id="Occupation" name="fatherOccupation"
								...
								<div>
									<label for="form-field-8">Contact Number <span
										...
										path="fatherContactNumber" placeholder="Annual Income"
							...
							<div class="widget-main">
								<div>
									<label for="form-field-8">Mother's Name </label> <input
										...
										name="motherFirstName" placeholder="First Name" /><br> <input
								...
								<div>
									<label for="form-field-8">Occupation</label> <input type="text"
										class="form-control" id="Occupation" name="motherOccupation"
										placeholder="Occupation" />
								</div>
								<hr />
								<div>
								...
								<div>
									<label for="form-field-8">Contact Number</label> <input
										...
										name="motherContactNumber" placeholder="Annual Income"
				...
				<div class="col-xs-12 col-sm-4" id="studDiv" style="">
					<div class="widget-box">
						...
						<div class="widget-body">
							<div class="widget-main">
								<div>
									<label for="form-field-8">Username <span
										style="color: red;">*</span></label> <input type="text"
										class="form-control" id="StudentUserName" name="Studentusername"
										placeholder="Student USer Name " required
										pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}"
										title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" />
								</div>
								<hr />
								<div>
									<label for="form-field-8">Password <span
										style="color: red;">*</span></label> <input type="text"
										class="form-control" id="" name="StudentPassword"
										placeholder="Student Password Income" required
										pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{6,}"
										title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters" />
								</div>
								<hr />
								<div>
									<label for="form-field-8"><b>Declaration Of Student</b></label>
									<h5>
										<p><input type="checkbox" id="checkDeclaration"/> &nbsp;I am aware of the Maharashtra Prohibition of Ragging
											Act, 1999 and I state that I will abide by all the rules and
											regulations of the said Act.</p>
									</h5>
								</div>
								<hr />
								<div class="form-actions center">
									...
									<button type="submit" class="btn btn-sm btn-success"
										name="TakeAddmission" id="TakeAddmission" style="display: none;" disabled="true">
										Submit <i
											class="ace-icon fa fa-arrow-right icon-on-right bigger-110"></i>
									</button>
								</div>
