...
<body>
	<div class="page-content">
		<s:form action="SaveAcademicYear.html" commandName="YearMaster"
			method="post" id="" class="form-horizontal">
			<div class="page-header center">
				<h1>Academic Year Master Page</h1>
				<br>
			</div>
			<div class="row">
				<div class="col-xs-12">
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right">
							Academic Year: </label>
						<div class="col-sm-9">
							<s:input type="text" path="acadamicYear" class="col-xs-3" id=""
		...
		<div id="Oprations" class="modal">
			...
			<s:form class="modal-content animate" action="YearOpration.html"
				method="post" commandName="YearMaster">
				...
				<div class="container">
					...
					<table class="">
						...
						<tr>
							...
							<td><input type="text" name="AcYear" id="AcYear"></td>
