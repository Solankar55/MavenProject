...
<div class="page-content">
		<div class="page-header">
			<center>
				<h1><b>Students Year Wise List Report</b></h1>
			</center>
		</div>
		<form action="studentReportYearWisePrint.html"  method="post" id=""
			...
			<div class="col-xs-12">
				...
				<div class="form-group ">
					<div class="col-sm-3 control-label no-padding-right">
						<button type="submit" class="btn btn-big btn-success" name="getStudentReport">
