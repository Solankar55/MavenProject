...
$(document).ready(function(){
	...
	$("#standardName").change(function(){
		...
		$("#StandardData").empty();
		$.getJSON('StudentPendingFeeRpt.html',{yearId:yearId,streamid:streamid,branchid : branchid,standardID:standardID}).done(function(data) {
			
			for (var i=0;i<data.length;i++)
				{
					
				$("#StandardData").append("<tr><td>"+data[i].admissionRegId+"</td><td>"+data[i].studentFirstName +" "+ data[i].studentLastName+ "</td><td>"+data[i].AcademicYear+"</td><td>"+data[i].streamName+"</td><td>"+data[i].branchName+"</td><td>"+data[i].standard+"</td><td>"+data[i].feeStatus+"</td><td>"+data[i].PendingFees+"</td></tr>");
...
<body>
	<div class="page-content">
		<div class="page-header">
			<center>
				<h1><b>Students Pending Fees Report</b> </h1>
			</center>
		</div>
		<form action="GetreportStudentPendingFees.html"  method="post" id=""
