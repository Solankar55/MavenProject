...
<title>Cancel Student Leaving Certificate List</title>
</head>
<body>
<div class="page-content">
			<div class="page-header center">
				<h1><b>Leaving Certificate Issued Student List</b></h1>
			</div>
			<div class="row">
			<div class="col-xs-12">
				<!-- PAGE CONTENT BEGINS -->
					...
					<div class="table-header"> Student List</div>
						<table id="dynamic-table" class="table  table-bordered table-hover">
							...
							<tbody id="ledgerTable">
								<c:forEach var="v" items="${cancelLeavingCertificateList}">
