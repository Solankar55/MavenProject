						...
						<div class="center">
							<h1>
								<i class="ace-icon fa fa-university red"></i> <span
									class="white">Staff Login </span><br>
							</h1>
							...
							<div id="login-box"
								...
								<div class="widget-body">
									<div class="widget-main">
										...
										<form action="GetStaffPassword.html" method="post">
											<fieldset>
												<label class="block clearfix"> <span
													class="block input-icon input-icon-right"> <input
														type="text" class="form-control" name="EmailAddress"
														placeholder="Email Address" /> <i class="ace-icon fa fa-user"></i>
												</span>
												</label> 
												<div class="clearfix">
													<button type="submit" name="GetStaffPass"
