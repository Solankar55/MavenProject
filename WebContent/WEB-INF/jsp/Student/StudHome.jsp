...
<div class="page-content">
		<div class="page-header">
			...
			<h2 style="color: red;">${MessageOfFee }</h2>
			<h2 style="color:red;">${MessageToNotice }</h2>
			<h2 style="color: red;">${MessageOfRequest }</h2>
			<h2 style="color: red;">${MessageOfDownload }</h2>
			<h3 style="color: red;">${StudentMsgOfAdmission}</h3>
			<h4 style="color: red;">${StudentMessage }</h4>
			<h3 style="color: red;">${StudMessageForLibrary}</h3>
		</div>
