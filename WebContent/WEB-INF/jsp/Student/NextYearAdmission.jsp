...
<title>Student Next Year Admission Profile</title>
...
$(document).ready(function(){
 	...
 	$("#nameasper").blur(function(){
 		...
 		$.getJSON('spliteStduentName.html',{studNameScc:studNameScc}).done(function(data){
 			...
 			$("#FlastName").val(surname);
 			var fatherName=data[1];
 			//alert(fatherName);
 			$("#middleName").val(fatherName);
 			$("#FfirstName").val(fatherName);
 			$("#mlastName").val(surname);
...
<body>
	<form action="TakeStudentNextYearAdmissionPage.html" method="post">
		<div class="page-content">
			<div class="page-header center">
				<h1>
					<b>Student Next Year Admission Page</b>
				</h1>
			</div>
			<c:forEach var="StudInfo" items="${StudentDetails}">
								...
								<div class="widget-main">
									...
									<div>
										<label for="form-field-8">Nationality</label> <input
											...
											id="nationality" name="studentNationality" readonly="true"
								...
								$(document).ready(function() {    
									...
									<div class="form-actions center">
										...
										<button type="submit" class="btn btn-sm btn-success"
											name="TakeAddmission" id="TakeAddmission"
											style="display: none;">
											Submit <i
												class="ace-icon fa fa-arrow-right icon-on-right bigger-110"></i>
										</button>
