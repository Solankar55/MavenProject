...
<div class="page-content">
		<form action="LibraryAcadamicMasterSave.html" 
			method="post" id="" class="form-horizontal">
			<div class="page-header center">
				<h1><b>Library Academic Year Master Page</b></h1>
			</div>
			<div class="row">
				<div class="col-xs-12">
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right">
							Academic Year: </label>
						<div class="col-sm-9">
							<input type="text" name="labacademicyear" class="col-xs-3" id=""
					...
					<div class="col-xs-12">
						<table id="dynamic-table" class="table  table-bordered table-hover">
							...
							<tbody id="AcdamicTableOpration">
								...
								<c:forEach var="A" items="${yearList}">
									<tr
										onclick="document.getElementById('Oprations').style.display='block'">
										<td><c:out value="${A.labacademicyearid}"></c:out></td>
										<td><c:out value="${A.labacademicyear}"></c:out></td>
									</tr>
								</c:forEach>
							</tbody>
						</table>
		...
		<div id="Oprations" class="modal">
			...
			<form class="modal-content animate" action="YearLabupdate.html"
				method="post" >
				...
				<div class="container">
					...
					<table class="">
						<tr>
							...
							<td><input type="text" name="labacademicyearid" id="AcYearID"
								readonly="true"></td>
						...
						<tr>
							...
							<td><input type="text" name="labacademicyear" id="AcYear"></td>
