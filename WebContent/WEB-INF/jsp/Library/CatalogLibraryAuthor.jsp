...
<body>
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<!-- PAGE CONTENT BEGINS -->
				<form action="AutherPageReportLab.html" method="get" id=""
					class="form-horizontal" target="_blank">
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right">
							Select Author:<span style="color: red;">*</span>
						</label>
						<div class="col-sm-9">
							<select id="author" name="Author" class="col-xs-3" required>
								<option value="">Select Author</option>
								<c:forEach var="Alist" items="${LibraryAuthorList }">
									<option>${Alist.author}</option>
								</c:forEach>
					...
					<div class="form-group ">
						...
						<div class="col-sm-3 control-label no-padding-right">
							<button type="submit" class="btn btn-big btn-success"
								name="AutherPageReport" value="Report Generate">
